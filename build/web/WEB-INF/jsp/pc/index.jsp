...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container" align="center">
            <div id="simple_introduce" >
                <div class="introduce">
                    <div class="inner-introduce-container-first">
                ...
                <div class="introduce">
                    <div class="inner-introduce-container-second">
                        <div id="second"></div>
                ...
                <div class="introduce">
                    <div class="inner-introduce-container-third">
                        <div id="third"></div>
