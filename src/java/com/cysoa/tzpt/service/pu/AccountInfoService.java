...
public class AccountInfoService extends UniversalService {
    ...
    public void execute(Map<String, Object> in, Map<String, Object> inHead, Map<String, Object> out, Map<String, Object> outHead) throws CustomException {
        ...
        if (account != null) {
            if (session.get("usr_custid") != null) {
                ...
                out.put("available_assets", "0.00"); //可用资产
                out.put("frozen_assets", "0.00");
                out.put("invested_assets", "0.00");    //已投资资产
                out.put("credit_line", "0.00");//可以借款额度
                out.put("debt_assets", "0.00");//已借金额
                out.put("gold_coin", "0.00");//金币 
            }
        }
    }
}
