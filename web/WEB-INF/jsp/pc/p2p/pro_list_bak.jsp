                                    ...
                                    <div class="tab-pane active" id="home">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <b>借款人:</b>${res['loaderbase_name']}
                                                <b>性别:</b>${res['loaderbase_sex']} 
                                                <b>婚姻状况:</b>
                                                <select class="selectpicker"  disabled="true" value="${res['loaderbase_marital_status']}">
                                                ...
                                                <b>公司行业</b> 
                                                <select class="selectpicker"  disabled="true" value="${res['loaderwork_company_industry']}">
                                               ...
                                               <b>现单位工作时间</b>   <select class="selectpicker" disabled="true"   value="${res['loaderwork_join_time']}">
                                                    <option value="1">5年以上</option>
                                                    <option  value="2">3～5年</option>
                                                    <option  value="3">1～3年</option>
                                                    <option  value="4">1年以内</option>
                                                </select>
                                                <b>月收入:</b>${res['loaderwork_income']}
                                            </li></ul>
                                    </div>
