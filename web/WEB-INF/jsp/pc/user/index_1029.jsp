            ...
            <tr>
                <td width="325" height="1000">
                    <div> 
                        ...
                        <div id="function_list" style="margin-left:20%;background: #4DCFBF">
                            <div id="personal_info" class="function-list-item">
                                ...
                                <ul class="function-child-list">
                                    ...
                                    <li id="stat"  href="<c:url value='/pc/p2p/information/person_statement.do' />">个人资料上传</li>
                                    <li id="qy_stat"  href="<c:url value='/pc/p2p/information/company_statement.do' />">企业资料上传</li>
